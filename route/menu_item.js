...
const routes = {
    ...
    "routes": [
        ...
        },
        {
            ...
            callback: function (req, res) {
                const {id, name, categoryId, description, cookingTime, price, size, image_url} = req.body;
                const menuItem = {id, name, categoryId, description, cookingTime, price, size, image_url};
